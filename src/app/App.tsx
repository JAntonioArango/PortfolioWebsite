...
const Preloader = () => (
  <motion.div
    ...
    className="fixed inset-0 z-[999] bg-white dark:bg-neutral-950 flex items-center justify-center text-neutral-950 dark:text-white overflow-hidden"
  >
    ...
    >
      ...
      <motion.div
        ...
        className="h-px bg-black/20 dark:bg-white/20 w-32"
      />
    </motion.div>
  </motion.div>
);
  ...
  return (
    <ThemeProvider>
      <Router>
        ...
        {!loading && (
          <div className="bg-white dark:bg-neutral-950 min-h-screen text-neutral-950 dark:text-white selection:bg-black/10 dark:selection:bg-white/20">
            <Navbar />
            <Routes>
