    ...
    <div className="bg-white dark:bg-neutral-950 min-h-screen text-neutral-950 dark:text-white pt-32 px-6">
      ...
      <div className="container mx-auto relative z-10">
        <div className="flex justify-between items-end mb-24">
           <div>
             <Link to="/" className="text-sm font-mono uppercase tracking-widest text-neutral-500 hover:text-neutral-950 dark:hover:text-white transition-colors mb-8 block">
               ← Back to Home
             </Link>
          ...
          {projects.map((project, index) => (
            ...
            >
              <Link to={`/work/${project.slug}`}>
                <div className="relative overflow-hidden aspect-[3/4] mb-6 bg-neutral-100 dark:bg-neutral-900 rounded-sm">
                   <img
                     src={project.image}
                     alt={project.title}
                   ...
                   <div className="absolute bottom-4 right-4 bg-black/10 dark:bg-white/10 backdrop-blur-md p-3 rounded-full opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                      <ArrowUpRight className="w-5 h-5 text-neutral-950 dark:text-white" />
                   </div>
                </div>
                <div className="flex justify-between items-baseline border-t border-black/10 dark:border-white/10 pt-4">
                   <div>
